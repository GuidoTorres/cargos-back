...
const getConsultaBienesSiga = async (req, res) => {
  try {
    ...
    const sqlQuery = `
      SELECT SP.SECUENCIA, SP.CODIGO_ACTIVO, SP.DESCRIPCION, SP.ESTADO, SP.ESTADO_CONSERV, SP.EMPLEADO_FINAL, S.SEDE, S.nombre_sede, CC.CENTRO_COSTO, CC.NOMBRE_DEPEND, 
        UF.TIPO_UBICAC, UF.COD_UBICAC, UF.UBICAC_FISICA, P.docum_ident, P.nombre_completo as RESPONSABLE, PP.nombre_completo as USUARIO_FINAL,  SP.NRO_SERIE, M.NOMBRE AS MARCA, SP.MODELO, SP.MEDIDAS, 
      ...
      FROM SIG_PATRIMONIO AS SP
        ...
        INNER JOIN SIG_PERSONAL PP ON (P.sec_ejec = SP.SEC_EJEC AND PP.empleado = SP.EMPLEADO_FINAL)
