...
const getEtiquetas = async (req, res) => {
  try {
    let { sede, centroCosto, ubicacion, usuario,familia, startSeq, endSeq } = req.query;
  ...
  `;
    ...
    const etiquetas = await sequelize.query(sqlQuery, {
      replacements: {
        grupoBien: null,
        claseBien: null,
        familiaBien: familia || null,
        startSeq: startSeq || null,
        endSeq: endSeq || null,
        sede: sede || null,
        tipoUbicac: centroCosto || null,
        codUbicac: ubicacion || null,
        empleadoFinal: usuario || null,
